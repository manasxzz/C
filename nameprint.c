...
void main()
{
 printf("MANAS                              MANASMANAS             MANASMANAS           MANAS                  MANAS             MANASMANAS           MANASMANASMANASMANASMANAS\n");
 printf("MANASMANAS                         MANASMANAS          MANASMANASMANAS         MANASMANAS             MANAS          MANASMANASMANAS         MANASMANASMANASMANASMANAS\n");
 printf("MANASMANAS                         MANASMANAS        MANAS        MANAS        MANAS MANAS            MANAS        MANAS        MANAS        MANAS\n");
